...
VALUES
    ...
    (5,4589756176,'Chandana', 'Jayawardena', 'chandana.jayawardena@example.com', 1000000005,'2002-11-02','No. 30, Main Street, Colombo 07, Sri Lanka', '1-Phase', '+94-75-567-8901',2),
    (6,2789869789,'Ruwan', 'Ratnayake', 'ruwan.ratnayake@example.com', 1000000006,'1098-06-30','No. 35, Main Street, Colombo 07, Sri Lanka', '3-Phase', '+94-75-678-9012',2),
    ...
    (8,7964528945,'Sunil', 'De Silva', 'sunil.desilva@example.com', 1000000008,'2024-08-21', 'No. 45, Main Street, Colombo 07, Sri Lanka', '3-Phase', '+94-72-890-1234',2),
    ...
    (13,7562479852,'Shan', 'Fonseka', 'shan.fonseka@example.com', 1000000013, '2024-08-21','No. 70, Main Street, Colombo 07, Sri Lanka', '1-Phase', '+94-76-345-6789',2),
    ...
    (15,9825761543,'Thilina', 'Kumara', 'thilina.kumara@example.com', 1000000015, '2024-08-21','No. 80, Main Street, Colombo 07, Sri Lanka', '1-Phase', '+94-76-567-8901',2);
